/**
 * Carrossel horizontal infinito — cortes (mesma lógica que ambient-marquee.js).
 */
(function () {
  "use strict";

  var root = document.querySelector("[data-cuts-marquee]");
  if (!root) return;

  var prefersReduced =
    window.matchMedia && window.matchMedia("(prefers-reduced-motion: reduce)").matches;

  var viewport = root.querySelector(".cuts-marquee__viewport");
  var track = root.querySelector(".cuts-marquee__track");
  var rowA = root.querySelector(".cuts-marquee__row");
  ...
  var wrapEl = document.querySelector(".netflix-gallery");
